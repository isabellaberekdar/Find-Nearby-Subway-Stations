            ...
            return (
                <div className='stationDetail'>
                    <div className='StationName'>
                        <h1>
                            <mark>{this.props.station.name}</mark>
                        </h1>
                        {this.props.station.trains}
                    </div>
                    <div className='DetailLineList'></div>

                    <p>{this.props.station.notes}</p>
                    {this.props.isAuthenticated ? null : (
                        <h5>
                            Log in to add any subway line to your favorites for quick access to
                            service information.
                        </h5>
                    )}
                    ...
                    <div className='LineService'>
                        <h2>
                            <mark>{`Line Service [as of ${this.props.timeUpdated}]`}</mark>
                        </h2>
                        <Status
...
export default connect(
    mapStateToProps,
    { addFavorite, deleteFavorite, setFilteredStations }
)(StationDetail);
